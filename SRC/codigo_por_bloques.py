...
Original file is located at
    https://colab.research.google.com/drive/16PdCd1S_B5j4bMWlmfTjkLHwkhNAS3f9
"""
...
def ingresar_vehiculo(admin_actual):
    ...
    while True:
        ...
        if placa not in usuarios['Placa']:
            ...
            print(f" Vehículo con placa {placa} ingresó a las {hora_ingreso}")
            break
...
def retirar_vehiculo(admin_actual):
    ...
    while True:
        ...
        if placa not in registro:
            ...
            historico['Fecha Registro'].append(hora_entrada.strftime('%Y-%m-%d %H:%M:%S'))
...
|      contacto@lmapark.co    |  Perfecto para tu auto, ideal para ti
+-----------------------------------------------------------------------+
...
def graficar_historico():
    ...
    # Crea un DataFrame con todas las columnas necesarias
    resumen = pd.DataFrame({
        'Ingresos': conteo_ingresos,
        'Retiros': conteo_retiros
    }).fillna(0)

    # Agrega conteo de registros si deseas incluirlo
    ...
    # Gráfica
    resumen.plot(kind='bar', figsize=(10, 6), edgecolor='black', colormap='Set2')
...
def menu_principal():
    ...
    while True:
        ...
        print("5️ Guardar y Salir")
        print("6️ Ver Gráfico Histórico")
        print("7️ Administración")
